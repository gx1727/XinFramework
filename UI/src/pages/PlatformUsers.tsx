...
export function PlatformUsersPage() {
  ...
  const [userToDelete, setUserToDelete] = useState<PlatformUserItem | null>(
    null
  )
  ...
  const handleStatusSubmit = async () => {
    ...
    setIsSubmitting(true)
    try {
      await platformUserApi.updateStatus(
        ...
        <div className="mb-4 grid grid-cols-3 gap-4">
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t.pages.platformUsers?.statsTotal || "平台用户总数"}
              </CardDescription>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t.pages.platformUsers?.statsActive || "启用中"}
              </CardDescription>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>
                {t.pages.platformUsers?.statsDisabled || "已停用"}
              </CardDescription>
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              <div className="relative max-w-sm flex-1">
                ...
                <Input
                  placeholder={
                    t.pages.platformUsers?.searchPlaceholder ||
                    "搜索 code / 姓名 / 账户 ID..."
                  }
                  className="pl-9"
                  value={searchTerm}
              ...
              <Badge variant="secondary">
                {t.pages.platformUsers?.matchedCount?.replace(
                  "{n}",
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>
                    {t.pages.platformUsers?.realName || "姓名"}
                  </TableHead>
                  <TableHead>
                    {t.pages.platformUsers?.nickname || "昵称"}
                  </TableHead>
                  <TableHead>角色</TableHead>
                  <TableHead>
                    {t.pages.platformUsers?.status || "状态"}
                  </TableHead>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            ...
            <DialogDescription>
              确定要删除平台用户 "{userToDelete?.real_name}"
              吗？删除不影响对应的登录账号。
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
