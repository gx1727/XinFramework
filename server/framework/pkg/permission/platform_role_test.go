...
// TestPostgresPlatformRoleRepository_NilDB_AllMethodsPropagateError
...
func TestPostgresPlatformRoleRepository_NilDB_AllMethodsPropagateError(t *testing.T) {
	ctx := context.Background()
	r := NewPlatformRoleRepository(nil)
